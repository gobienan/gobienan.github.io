...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    assignmentID: function assignmentID() {
      ...
      var c = url.searchParams.get("assignmentId");
      console.log(c);
      return c;
    },
    turkSubmitTo: function turkSubmitTo() {
      var url = new URL(window.location.href);
      var c = url.searchParams.get("turkSubmitTo");
      console.log(c);
      return c + "/mturk/externalSubmit";
    }
  },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('Intro'), _vm._v(" "), _c('SocialContact'), _vm._v(" "), _c('About'), _vm._v(" "), _c('Contact'), _vm._v(" "), _c('form', {
    staticStyle: {
      "z-index": "99",
      "position": "fixed",
      "bottom": "0",
...
//# sourceMappingURL=app.f8d56b11a690576eeb7d.js.map